...
# 	# The residue name is a combination of the AA 3-letter code and its index in the Abeta42 protofibril system
# 	# Read in the file which contains two columns. The first column are the residue names. 
# 	# The second column contains the number of carbon atoms
# 	# CSV reader returns a list where each element a list containing the residue name 
# 	# and number of carbon atoms in positions 0 and 1 respectively.
# 	r = csv.reader(open('chain%(chain_num)d_table.dat' % vars()), delimiter=' ')

# 	# A list containing the three code part of the name
# 	residue_map = []

# 	# Maps the residue name to the number of carbon atoms
# 	residue_map_dict = {}
# 	for line in r:
# 		residue_name = line[0]
# 		residue_map.append(residue_name)
# 		residue_map_dict[residue_name] = int(line[1])
