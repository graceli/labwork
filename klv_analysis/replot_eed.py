...
def plot_eed(file_name="test.png"):
	...
	fig.subplots_adjust(top=0.95, bottom=0.15, left=0.15, right=0.95, wspace=0.001)
	...
	nax=0
	for eed_data in [low_ratio, high_ratio]:
...
def main():
	"""docstring for main"""
	plot_eed('KLV_eed_15to1_2to1_with_error.png')
