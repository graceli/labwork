...
proc ::MovieMaker::renderframe { basefilename } {
  ...
  switch $renderer {
    ...
    tachyon {
      ...
      switch $imgformat {
        bmp {
          set rendercmd [concat $rendercmd \
            "-auto_skylight 0.8 $scenefilename -format BMP -aasamples 4 -o $imgfilename"]
        }

        ppm {
          set rendercmd [concat $rendercmd \
            "-auto_skylight 0.8 $scenefilename -format PPM -aasamples 4 -o $imgfilename"]
        }

        rgb {
          set rendercmd [concat $rendercmd \
            "-auto_skylight 0.8 $scenefilename -format RGB -aasamples 4 -o $imgfilename"]
        }

        tga {
          set rendercmd [concat $rendercmd \
            "-auto_skylight 0.8 $scenefilename -format Targa -aasamples 4 -o $imgfilename"]
        }
      ...
      #commented out by JH so that can create all .dat files for rendering in ccb
      #render Tachyon $scenefilename $rendercmd
      render Tachyon $scenefilename " "
    } 
    povray {
