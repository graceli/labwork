...
{
  static char *desc[] = {
	"g_eed is a modified version of g_dist to calculate end to end distances of proteins",
	"must manually determine the last two CA atoms of the protein and create an index group",
	"with the selection"
  };
...
/* end comment */
    ...
    rm_pbc(&top->idef, -1, natoms,box,x,x);
